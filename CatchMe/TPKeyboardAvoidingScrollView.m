...
//  This code is free for commerical use and can be found online here: https://github.com/michaeltyson/TPKeyboardAvoiding
//  The code is used to resize the viewable area of a window when the keyboard appears.
